...
//  [29]    = thrust_on
//  [28:24] = angle + 45 (0-90, so it's always positive)
//  [23:16] = fuel scaled 0-255
//  [15:8]  = vertical velocity scaled 0-255 (0=slow, 255=fast)
//  [7:0]   = horizontal velocity scaled 0-255
// ============================================================
